...
local Library = {
    ...
    FontColor = Color3.fromRGB(255, 255, 255); -- Finish
    MainColor = Color3.fromRGB(0, 15, 30); -- Finish
    BackgroundColor = Color3.fromRGB(5, 5, 20); -- Finish
    AccentColor = Color3.fromRGB(232, 0, 240); -- Finish
    OutlineColor = Color3.fromRGB(0, 0, 5); -- Finish
